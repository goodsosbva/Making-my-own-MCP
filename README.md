...
│   ├── 실습_가이드.html         # 📚 상세한 실습 가이드
│   └── 실습_정리.md             # 📝 실습 과정 정리 문서
...
- **`실습_가이드.html`**: MCP 서버와 RAG 시스템 실습을 위한 상세한 가이드
- **`실습_정리.md`**: 실습 과정에서 학습한 내용과 핵심 개념 정리
- **`mcp_rag_practice_summary.pdf`**: RAG 시스템 실습 요약 PDF 문서
...
**`rag-server/실습_가이드.html`**은 MCP 서버와 RAG 시스템 실습을 위한 상세한 가이드입니다:

- **실습 개요 및 목표**: 단계별 학습 목표 제시
- **MCP 서버 구조**: 기본 개념과 구현 방법 설명
- **수학 서버 실습**: 간단한 도구 구현부터 시작
- **RAG 시스템 실습**: LangChain을 활용한 고급 기능 구현
- **보안 고려사항**: API 키 관리의 모범 사례
- **문제 해결**: 일반적인 오류와 해결 방법

### 실습 정리 (실습\_정리.md)

**`rag-server/실습_정리.md`**는 실습 과정에서 학습한 내용을 체계적으로 정리한 문서입니다:

- **핵심 개념 정리**: MCP, RAG, LangChain의 핵심 내용
- **구현 과정 요약**: 각 단계별 구현 내용과 코드 구조
- **학습 포인트**: 실습을 통해 얻은 인사이트와 경험
- **향후 발전 방향**: 추가 학습 및 개선 방향 제시

### 실습 자료 활용 방법

1. **실습 시작 전**: `실습_가이드.html`을 통해 전체 과정 파악
2. **실습 진행 중**: 각 단계별로 가이드 참조하며 진행
3. **실습 완료 후**: `실습_정리.md`를 통해 학습 내용 점검
4. **문제 발생 시**: 가이드의 문제 해결 섹션 참조
...
- **실습 자료 작성**: 학습 내용의 체계적 정리 및 가이드 작성
...
문제가 발생했을 때는 **`실습_가이드.html`**과 **`실습_정리.md`**를 참조하여 해결 방법을 찾을 수 있습니다.
...
- **교육 자료 개발**: AI 도구 활용을 위한 실습 가이드 작성
...
_이 문서는 MCP 서버와 다양한 AI 도구들의 실습 과정을 종합 정리한 것입니다. 최신 코드의 보안 기능과 환경 변수 관리 방법이 반영되어 있으며, 상세한 실습 가이드와 정리 문서를 포함하여 실무 적용 가능성을 고려하여 작성되었습니다._
